...
## 1. Создание формы
Для создания интерфейса калькулятора поспользуемся программой 
[SceneBuilder](https://gluonhq.com/products/scene-builder/). 

При создании проекта выбираем тип "Empty".
В качестве основы используем **GridPane** (слева в списке *Containers*). 
В качестве "экрана" калькулятора добавим **TextArea**, 
в качестве кнопок несколько **Button**.

- Чтобы добавить колонку/столбец в сетку (GridPane), достаточно отпустить нужный
